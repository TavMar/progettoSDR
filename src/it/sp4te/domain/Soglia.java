...
public class Soglia {
	...
	public Soglia(double pfa){
		this.pfa = pfa;
	}

	public double getValoreMedio(double[] energie){
	...
	public double getVarianza(double[] energie){
		double varianza = 0;
		double m = this.getValoreMedio(energie);
		int l = energie.length;
		for (int i=0; i<l; i++){
